...
#define HOMING_BACKOFF_POST_MM { 2, 0, 0 }  // (mm) Backoff from endstops after homing
...
#define Z_STEPPER_AUTO_ALIGN
  ...
  #define Z_STEPPER_ALIGN_XY { {  25, 110 }, { 195,  110 } }
  ...
  //#define Z_STEPPER_ALIGN_KNOWN_STEPPER_POSITIONS
    ...
    #define Z_STEPPER_ALIGN_STEPPER_XY { { 210.7, 102.5 }, { 152.6, 220.0 }, { 94.5, 102.5 } } TODO
  #else
    // Amplification factor. Used to scale the correction step up or down in case
    // the stepper (spindle) position is farther out than the test point.
    #define Z_STEPPER_ALIGN_AMP 0.9       // Use a value > 1.0 NOTE: This may cause instability!
  #endif

  // On a 300mm bed a 5% grade would give a misalignment of ~1.5cm
  #define G34_MAX_GRADE              5    // (%) Maximum incline that G34 will handle
  #define Z_STEPPER_ALIGN_ITERATIONS 3    // Number of iterations to apply during alignment
  #define Z_STEPPER_ALIGN_ACC        0.04 // Stop iterating early if the accuracy is better than this
...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 80*60, 80*60, 6*60, 5*60 } // Feedrates for manual moves along X, Y, Z, E from panel
...
//#define LCD_SHOW_E_TOTAL
  ...
  #define EVENT_GCODE_SD_STOP "G91; G1 Z5 F150; G90; G1 X10 F3000; M84 X Y E"       // G-code to run on Stop Print (e.g., "G28XY" or "G27")
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define FILAMENT_CHANGE_UNLOAD_LENGTH      505  // (mm) The length of filament for a complete unload.
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Prutscha 32X Ready."
  #define USER_SCRIPT_AUDIBLE_FEEDBACK
  #define USER_SCRIPT_RETURN  // Return to status screen after a script

  //#define USER_DESC_1 "Load Filament"
  //#define USER_GCODE_1 "M117 Loading filament...\nG21\nG90\nG92\nG1 E20 F420\nG92 E0\nG1 E480 F2000\nG92 E0\nG1E50 F300\nG92 E0\nM400\nM117 Loading done!\nG4 S3"

  //#define USER_DESC_2 "Unload Filament"
  //#define USER_GCODE_2 "M117 Unloading filament...\nG21\nG90\nG92 E0\nG1 E10 F100\nG92 E0\nG1 E-500 F2000\nG92 E0\nM400\nM117 Unloading done!\nG4 S3"

  #define USER_DESC_1 "Enable Cold Extrusion"
  #define USER_GCODE_1 "M302 P1"

  #define USER_DESC_2 "Disable Cold Extrusion"
  #define USER_GCODE_2 "M302 P0"

  #define USER_DESC_3 "Nozzle Change"
  #define USER_GCODE_3 "G28\nG1 X112 Y5 Z140 F2000\nM104 S250\nM117 Setting Nozzle to 250C\nG4 s10\nM0 Click when Finished\nM104 S0"
#endif
