...
#define STRING_CONFIG_H_AUTHOR "derebbe" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Prutscha 32X"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  // e3D 24V 40 Watts heater cartridge with std. v6 hotend and silicon sock
  #define DEFAULT_Kp 19.29
  #define DEFAULT_Ki 1.46
  #define DEFAULT_Kd 63.67
#endif // PIDTEMP
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // Anycubic i3 Mega 160W Ultrabase, 24V
  #define DEFAULT_bedKp 11.20
  #define DEFAULT_bedKi 2.19
  #define DEFAULT_bedKd 38.23
#endif // PIDTEMPBED
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 4500, 4500, 350, 150 }
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 3000, 3000, 100, 1250 }
 ...
 */
#define NOZZLE_TO_PROBE_OFFSET { 29, 0, -0.925 }
...
#define Y_MIN_POS -5
#define Z_MIN_POS 0
#define X_MAX_POS (215 + (X_MIN_POS * -1))
#define Y_MAX_POS (215 + (Y_MIN_POS * -1))
